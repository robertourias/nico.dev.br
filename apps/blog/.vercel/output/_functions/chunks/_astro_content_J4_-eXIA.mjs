import { aq as objectType, af as dateType, a5 as arrayType, aF as stringType, c as AstroError, V as RenderUndefinedEntryError, ab as createComponent, aH as unescapeHTML, aA as renderTemplate, a0 as UnknownContentCollectionError, ai as escape, aB as renderUniqueStylesheet, ax as renderScriptElement, ac as createHeadAndContent, as as renderComponent } from './astro/server_D7O-e-38.mjs';
...
import { u as unflatten } from './parse_DV1l6nJx.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DfBknrSG.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_th7-fk_w.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BX5XmRz2.mjs');
