...
export function ClinicaHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 px-6 py-4 clin-glass">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        <a
          href="#topo"
          className="flex items-center gap-2.5 font-bold text-foreground text-lg"
        ...
        <div className="hidden lg:block">
          <a
            href="#agendamento"
            className="clin-cta-highlight inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-semibold text-white"
