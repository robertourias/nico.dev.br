...
export function NewsletterForm() {
  ...
  if (submitted) {
    return (
      <Alert variant="success" className="w-full max-w-md text-left">
        <AlertDescription>
          Inscrição confirmada! Em breve você recebe as próximas vagas e tendências direto no seu e-mail.
        </AlertDescription>
      </Alert>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-3 w-full max-w-md">
      ...
      <p className="text-xs text-[var(--devpath-fg-faint)] text-center">
