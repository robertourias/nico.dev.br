...
// e alterna `data-visible`, que o CSS em theme.css (`.economia-reveal`) anima.
// Implementado com IntersectionObserver puro (sem libs de animação) para
// manter a página leve. Dispara uma única vez — não reverte ao rolar para
// fora da tela, evitando distração em scroll repetido.
export function Reveal({ children, variant = "fade-up", delayMs = 0, className, ...rest }: RevealProps) {
  ...
  return (
    <div
      ref={ref}
      className={`economia-reveal ${className ?? ""}`}
